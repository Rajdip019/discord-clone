          ...
          {dm.slice(1,3).map((dms) => {
            return (
              ...
              <div className="w-full flex items-center hover:bg-gray-700 px-2 py-2 rounded-lg cursor-pointer transition-all justify-between">
                ...
                <div>
              <div className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 text-gray-400 bg-gray-800 p-2 rounded-full mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
</svg>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 text-gray-400 bg-gray-800 p-2 rounded-full rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
