...
const Footer = () => {
  return (
    <footer className="bg-[#23262B] font-Helvetica py-20 overflow-hidden">
      <div className=" max-w-[1024px] mx-auto">
        <div className="grid lg:grid-cols-6 md:grid-cols-4 w-11/12 lg:w-full mx-auto">
          <div className="col-span-2 row-span-2 mb-10 md:mb-0">
            <h1 className="text-skin-main uppercase font-Helvetica mx-auto font-extrabold text-4xl">
              Imagine a Place...
            </h1>
            <div className="flex items-center my-5">
              <img src="/assets/USA Flag.png" alt="" className="w-8 mr-2" />
              <p className="text-white text-sm">English, USA</p>
            </div>
            <div className="flex items-center text-white my-5 justify-start">
              {/* Twitter */}
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
                class="socialIcon-32i0_n mx-3 "
              >
                <path
                  fill="currentColor"
              ...
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="socialIcon-32i0_n mx-3  rounded-xl"
              >
                <path
                  fill="currentColor"
          ...
          <div className="mr-auto md:ml-10">
            <h3 className="text-skin-main">Product</h3>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
              Download
            </a>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
              Nitro
          ...
          <div className="mr-auto md:ml-10">
            <h3 className="text-skin-main">Company</h3>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
              About
            </a>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
          ...
          <div className="mr-auto md:ml-10">
            <h3 className="text-skin-main">Resources</h3>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
              College
            </a>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
          ...
          <div className="mr-auto md:ml-10">
            <h3 className="text-skin-main">Policies</h3>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
              Terms
            </a>
            <a className="text-white cursor-pointer hover:underline transition-all my-3 font-Helvetica block text-sm">
        ...
        <hr className="text-skin-main bg-skin-main my-8 w-11/12 mx-auto md:w-full " />
        ...
        <button className="bg-[#5964F2] text-white px-4 py-2 rounded-full font-Helvetica text-sm hover:bg-[#6d75ee] transition-all duration-500">
            Open Discord
        </button>
        </div>
      </div>
